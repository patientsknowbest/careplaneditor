                ...
                ut(function () {
                    ...
                    u &&
                        ...
                        e.getComputedStyle &&
                            ...
                            (n.boxSizingReliable = "4px" === (e.getComputedStyle(h, null) || { width: "4px" }).width),
            ...
            if (g) {
                for (
                    ...
                    (a = Ft.exec(n[l]) || []),
                        ...
                        (h = ut.event.special[d] || {}),
                        (c = ut.extend({ type: d, origType: m, data: i, handler: r, guid: r.guid, selector: s, needsContext: s && ut.expr.match.needsContext.test(s), namespace: v.join(".") }, o)),
                        ...
                        for (f = o[o.length - 1].ownerDocument, ut.map(o, v), l = 0; u > l; l++)
                            (a = o[l]),
                                tn.test(a.type || "") &&
                                    ...
                                    ut.contains(f, a) &&
                                    (a.src ? ut.ajax({ url: a.src, type: "GET", dataType: "script", async: !1, global: !1, throws: !0 }) : ut.globalEval((a.text || a.textContent || a.innerHTML || "").replace(rn, "")));
                    i = s = null;
                }
                return this;
            },
            ...
            position: function () {
                if (this[0]) {
                    ...
                    return (
                        ...
                        { top: t.top - n.top - ut.css(r, "marginTop", !0), left: t.left - n.left - ut.css(r, "marginLeft", !0) }
                    );
                }
            },
...
//    }),
        define("text!templates/snippet/image.html", [], function () {
            return '<!-- Image --> \n<img src="/images/hosted/<%= id %>" alt="<%= label %>" style=" max-width: 720px; width: 100%; height: auto;"></img>\n';
        }),
    define("text!templates/snippet/button.html", [], function () {
        return '<!-- Button -->\n<div class="form-group">\n  <label class="col-sm-6 control-label" for="<%= id %>"><%= label %></label>\n  <div class="col-sm-6">\n    <button id="<%= id %>" name="<%= id %>" class=\'btn <%= buttontype %>\'><%= buttonlabel %></button>\n  </div>\n</div>\n';
    }),
// <!-- Button (Double) -->\n
//    define("text!templates/snippet/paragraph.html", [], function () {
...
//    }),
    ...
    define("text!templates/snippet/textinput.html", [], function () {
        return '<!-- Text input-->\n<div class="row">\n  <div class="col-sm-6">\n    <label class="cp_label" for="<%= id %>"><%= label %></label>\n  </div>\n  <div class="col-sm-6" style="margin-top: 15px;">\n    <input type="text" placeholder="<%= placeholder %>" name="<%= id %>" id="<%= id %>" class="form-control" style="width: 100%;"></input>\n    <% if (helptext.length > 0) { %><span class="help-block"><%= helptext %></span><% } %>  \n  </div>\n</div>\n';
    }),
    define("text!templates/snippet/multiplecheckboxes.html", [], function () {
        return '<!-- Multiple Checkboxes -->\n<div class="row">\n  <div class="col-sm-6">\n    <label class="cp_label" for="<%= name %>"><%= label %></label>\n  </div>\n  <div class="col-sm-6" style="margin-top: 15px;"><% _.each(checkboxes, function(checkbox, i){ %>\n    <div class="form-check">\n      <input type="checkbox" class="form-check-input form-control" name="<%= name+\'-\'+i %>" id="<%= name+\'-\'+i %>" value="<%= checkboxesValues[i] %>"> <%= checkboxesValues[i] %></input>\n    </div><% }); %>\n  </div>\n</div>\n';
    }),
    define("text!templates/snippet/selectbasic.html", [], function () {
        return '<!-- Select Basic -->\n<div class="row">\n    <div class="col-sm-6">\n      <label class="cp_label" for="<%- id %>"><%- label %></label>\n    </div>\n    <div class="col-sm-6" style="margin-top: 15px;">\n      <select id="<%- id %>" name="<%- id %>" ><% _.each(options, function(option) { %>\n        <option value="<%- option %>"><%- option %></option><% }); %>\n      </select>\n    </div>\n  </div>\n';
    }),
    define("text!templates/snippet/textarea.html", [], function () {
        return '<!-- Textarea -->\n<div class="row" style="margin-top: 15px;">\n  <div class="col-sm-12">\n    <label class="cp_label" for="<%= id %>"><%= label %></label>\n    <textarea class="form-control" name="<%= id %>" id="<%= id %>" rows="3" style="width: 100%;"><%= textarea %></textarea>\n  </div>\n</div>\n';
    }),
    define("templates/snippet/snippet-templates", [
        ...
        "text!templates/snippet/image.html",
        "text!templates/snippet/button.html",
        "text!templates/snippet/paragraph.html",
        ...
        var t = e("text!templates/snippet/formname.html"),
            ...
            u = e("text!templates/snippet/image.html"),
            a = e("text!templates/snippet/button.html"),
            f = e("text!templates/snippet/paragraph.html"),
            ...
            v = e("text!templates/snippet/dateinput.html"),
...
+(function (e) {
        ...
        return n.View.extend({
            ...
            render: function () {
                ...
                n.collection !== undefined
                    ...
                    e("#formtabs").append(this.tabNavTemplate({ title: this.options.title, id: this.id })),
    ...
    define("text!templates/app/renderform.html", [], function () {
        return '<div class="form-inline">\n  <style media="screen">\n    a {word-wrap: break-word;}\n    .form-group {width: 100%; !important}\n    .cp_label {font-size: 18px;font-weight: 900;}\n    .cp_whiteBox {background-color:#ffffff; padding:15px; margin-bottom:10px; margin-top:10px; border-radius: 10px;}\n  </style>\n  <div class="cp_whiteBox">\n    <%= text %>\n  </div>\n</div>\n';
    }),
    ...
    define("text!data/content.json", [], function () {
        return '[\n  {\n    "title": "Image",\n    "fields": {\n      "id": {\n        "label": "Image Name",\n        "type": "input",\n        "value": "imageName.png"\n      },\n      "label": {\n        "label": "Image Alt Text",\n        "type": "input",\n        "value": "Alt Text"\n      }\n    }\n  },\n  {\n    "title": "Single Button",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "singlebutton"\n      },\n      "label": {\n        "label": "Label Text",\n        "type": "input",\n        "value": "Single Button"\n      },\n      "buttonlabel": {\n        "label": "Button Label",\n        "type": "input",\n        "value": "Button"\n      },\n      "buttontype": {\n        "label": "Button Type",\n        "type": "select",\n        "value": [\n          {\n            "value": "btn-default",\n            "label": "Default",\n            "selected": false\n          },\n          {\n            "value": "btn-primary",\n            "label": "Primary",\n            "selected": true\n          },\n          {\n            "value": "btn-info",\n            "label": "Info",\n            "selected": false\n          },\n          {\n            "value": "btn-success",\n            "label": "Success",\n            "selected": false\n          },\n          {\n            "value": "btn-warning",\n            "label": "Warning",\n            "selected": false\n          },\n          {\n            "value": "btn-danger",\n            "label": "Danger",\n            "selected": false\n          },\n          {\n            "value": "btn-inverse",\n            "label": "Inverse",\n            "selected": false\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Double Button",\n    "fields": {\n      "id": {\n        "label": "Button 1 ID / Name",\n        "type": "input",\n        "value": "button1id"\n      },\n      "label": {\n        "label": "Label Text",\n        "type": "input",\n        "value": "Double Button"\n      },\n      "button1label": {\n        "label": "Button Label",\n        "type": "input",\n        "value": "Good Button"\n      },\n      "button1type": {\n        "label": "Button Type",\n        "type": "select",\n        "value": [\n          {\n            "value": "btn-default",\n            "label": "Default",\n            "selected": false\n          },\n          {\n            "value": "btn-primary",\n            "label": "Primary",\n            "selected": false\n          },\n          {\n            "value": "btn-info",\n            "label": "Info",\n            "selected": false\n          },\n          {\n            "value": "btn-success",\n            "label": "Success",\n            "selected": true\n          },\n          {\n            "value": "btn-warning",\n            "label": "Warning",\n            "selected": false\n          },\n          {\n            "value": "btn-danger",\n            "label": "Danger",\n            "selected": false\n          },\n          {\n            "value": "btn-inverse",\n            "label": "Inverse",\n            "selected": false\n          }\n        ]\n      },\n      "id2": {\n        "label": "Button 2 ID / Name",\n        "type": "input",\n        "value": "button2id"\n      },\n      "button2label": {\n        "label": "Button Label",\n        "type": "input",\n        "value": "Scary Button"\n      },\n      "button2type": {\n        "label": "Button Type",\n        "type": "select",\n        "value": [\n          {\n            "value": "btn-default",\n            "label": "Default",\n            "selected": false\n          },\n          {\n            "value": "btn-primary",\n            "label": "Primary",\n            "selected": false\n          },\n          {\n            "value": "btn-info",\n            "label": "Info",\n            "selected": false\n          },\n          {\n            "value": "btn-success",\n            "label": "Success",\n            "selected": false\n          },\n          {\n            "value": "btn-warning",\n            "label": "Warning",\n            "selected": false\n          },\n          {\n            "value": "btn-danger",\n            "label": "Danger",\n            "selected": true\n          },\n          {\n            "value": "btn-inverse",\n            "label": "Inverse",\n            "selected": false\n          }\n        ]\n      }\n    }\n  }\n]';
    }),
    define("text!templates/app/render.html", [], function () {
        return '<div class="tooltip" style="opacity: 1;">\n  <button onclick="copyFunction()" onmouseout="outFunc()" class="copyButton">\n    <span class="tooltiptext" id="myTooltip">Copy Care Plan to clipboard</span>\n    Copy care plan\n    </button>\n</div>\n<h3>Care Plan code:</h3>\n<textarea id="render" class="col-md-12"></textarea>\n';
    }),
...
//    }),
    define("app/app", [
        ...
        return {
            initialize: function () {
                new s({ title: "Input", collection: new r(JSON.parse(u)) }),
                    new s({ title: "Radios / Checkboxes", collection: new r(JSON.parse(a)) }),
                    new s({ title: "Select", collection: new r(JSON.parse(f)) }),
                    new s({ title: "Content", collection: new r(JSON.parse(l)) }),
                    new s({ title: "View Care Plan code", content: c }),
//                    new s({ title: "About", content: h }),
                    e("#components .tab-pane").first().addClass("active"),
                    e("#formtabs li").first().addClass("active"),
                    new o({ title: "Original", collection: new i([{ title: "Form Name", fields: { name: { label: "Form Name", type: "input", value: "Form Name" } } }]) });
            },
        };
    }),
    require.config({
        baseUrl: "assets/js/lib/",
        shim: { backbone: { deps: ["underscore", "jquery"], exports: "Backbone" }, underscore: { exports: "_" }, bootstrap: { deps: ["jquery"], exports: "$.fn.popover" } },
